    ...
    <>
      ...
      <section className="page-header" style={{ borderBottom: '3px solid #B45309' }}>
        <div className="container">
          <h2>
            <i className="fa-solid fa-layer-group" style={{ color: '#B45309', marginRight: '12px' }}></i>
        ...
        <div className="container">
          <div className="edu-mission-grid">
            <div className="edu-mission-card" data-aos="fade-up">
              <div className="edu-mission-icon"><i className="fa-solid fa-layer-group" style={{ color: '#B45309' }}></i></div>
          ...
          <div className="edu-values-grid">
            {steps.map((s, i) => (
              <div key={i} className="edu-value-card" data-aos="fade-up" data-aos-delay={i * 100}>
                <span className="edu-value-icon"><i className={s.icon} style={{ color: '#B45309' }}></i></span>
      ...
      <section className="edu-values-section" style={{ background: 'var(--bg-secondary, #f8f9fa)' }}>
        <div className="container">
          ...
          <div className="edu-values-grid">
            {features.map((f, i) => (
              <div key={i} className="edu-value-card" data-aos="fade-up" data-aos-delay={i * 100}>
                <span className="edu-value-icon"><i className={f.icon} style={{ color: '#B45309' }}></i></span>
          ...
          <div className="edu-mission-grid">
            {useCases.map((uc, i) => (
              <div key={i} className="edu-mission-card" data-aos="fade-up" data-aos-delay={i * 100}>
                <div className="edu-mission-icon"><i className={uc.icon} style={{ color: '#B45309' }}></i></div>
