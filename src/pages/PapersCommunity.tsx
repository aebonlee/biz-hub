...
const PapersCommunity = (): ReactElement => {
  ...
  return (
    <>
      ...
      <section className="page-header" style={{ borderBottom: '3px solid #0284C7' }}>
        <div className="container">
          <h2>
            <i className="fa-solid fa-users" style={{ color: '#0284C7', marginRight: '12px' }}></i>
        ...
        <div className="container">
          <div className="edu-mission-grid">
            <div className="edu-mission-card" data-aos="fade-up">
              <div className="edu-mission-icon"><i className="fa-solid fa-users" style={{ color: '#0284C7' }}></i></div>
          ...
          <div className="edu-values-grid">
            {features.map((f, i) => (
              <div key={i} className="edu-value-card" data-aos="fade-up" data-aos-delay={i * 100}>
                <span className="edu-value-icon"><i className={f.icon} style={{ color: '#0284C7' }}></i></span>
          ...
          <div className="edu-mission-grid">
            {targets.map((tg, i) => (
              <div key={i} className="edu-mission-card" data-aos="fade-up" data-aos-delay={i * 100}>
                <div className="edu-mission-icon"><i className={tg.icon} style={{ color: '#0284C7' }}></i></div>
